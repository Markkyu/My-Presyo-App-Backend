...
app.get("/api/category/:category_id/products", (req, res) => {
  ...
  connection.query(
    `SELECT * FROM product_info WHERE product_category='${category_id}' ORDER BY product_name`,
    (err, rows, fields) => {
      if (err) throw err;
...
app.delete("/api/category", (req, res) => {
  ...
  connection.query(
    `DELETE FROM category WHERE category_id='${category_id}' ORDER BY category_name`,
...
app.put("/api/products", (req, res) => {
  ...
  connection.query(
    `UPDATE product_info SET product_name='${product_name}', product_price='${product_price}' WHERE product_id = ${product_id}`,
